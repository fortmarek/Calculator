...
//  Calculator
//
//  Created by Marek Fořt on 26.04.15.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "mf.Calculator" in the application's documents Application Support directory.
